...
***Data is a CSV file with five cloumns, 5572 rows total size of 504KB. Column v1 identifies message as ham or spam, column v2 is the message and column3, column4, column5 are additional messages. Each of object type text.***
...
Other techniques like __Use of more data__  is a simple one that can help prevent overfitting. Usage of more data helps model reach solutions that are more flexible as it accommodate more coditions. 
...
*Selecting and Fine tuning using one or more effective techniques can help improve your model performance. In certain cases it could also be totally new __innovative approach__ specific to the problem can result in imporved outcomes. Learning and improving for experimentation is the key*. 
