...
experiment_name = "UdacityPrjEmailSpamExperiment" # PLACEHOLDER
iteration = "42"  # PLACEHOLDER
run_id = "AutoML_9a459769-5f1a-47e4-a2b6-9f860bd85c2f_42"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':False,'enable_stack_ensembling':False,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN'],'whitelist_models':None,'compute_target':'cpu-cluster','enable_dnn':True,'experiment_exit_score':None,'experiment_timeout_minutes':1440,'featurization':'auto','hyperdrive_config':None,'grain_column_names':None,'is_timeseries':False,'iteration_timeout_minutes':1440,'max_concurrent_iterations':4,'metric_operation':'maximize','model_explainability':True,'n_cross_validations':None,'name':'UdacityPrjEmailSpamExperiment','path':'./sample_projects/UdacityPrjEmailSpamExperiment','primary_metric':'AUC_weighted','region':'centralus','resource_group':'epe-poc-nazeer','subscription_id':'16bc73b5-82be-47f2-b5ab-f2373344794c','task_type':'classification','validation_size':0.2,'test_size':None,'vm_type':'STANDARD_DS12_V2','workspace_name':'nahmed30-azureml-workspace','label_column_name':'v1','positive_label':None,'save_mlflow':True,'enable_batch_run':True,'dataset_id':'3527a22f-75c2-4ae0-81f9-28549e60c632'} # PLACEHOLDER
pipeline_spec = "{\"objects\": [{\"class_name\": \"StandardScaler\", \"module\": \"sklearn.preprocessing\", \"param_args\": [], \"param_kwargs\": {\"with_mean\": false, \"with_std\": true}, \"prepared_kwargs\": {}, \"spec_class\": \"preproc\"}, {\"class_name\": \"LogisticRegression\", \"module\": \"sklearn.linear_model\", \"param_args\": [], \"param_kwargs\": {\"C\": 24.420530945486497, \"class_weight\": null, \"multi_class\": \"ovr\", \"penalty\": \"l2\", \"solver\": \"lbfgs\"}, \"prepared_kwargs\": {}, \"spec_class\": \"sklearn\"}], \"pipeline_id\": \"eb060ff7ba0bf70687128be84d0fa9ce7cae70ac\", \"module\": \"sklearn.pipeline\", \"class_name\": \"Pipeline\", \"pipeline_name\": \"{ StandardScaler, LogisticRegression }\"}" # PLACEHOLDER
pipeline_id = "eb060ff7ba0bf70687128be84d0fa9ce7cae70ac" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"3527a22f-75c2-4ae0-81f9-28549e60c632\"}}" # PLACEHOLDER
