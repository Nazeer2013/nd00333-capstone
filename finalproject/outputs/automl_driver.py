...
workspace_name = "nahmed30-azureml-workspace" # PLACEHOLDER
subscription_id = "16bc73b5-82be-47f2-b5ab-f2373344794c" # PLACEHOLDER
resource_group = "epe-poc-nazeer" # PLACEHOLDER
experiment_name = "SMSspam-aml-experiment-v1" # PLACEHOLDER
iteration = "34"  # PLACEHOLDER
run_id = "AutoML_9f0af417-b476-41cc-a554-ea9f00a33e6c_34"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'path':None,'name':'SMSspam-aml-experiment-v1',
'subscription_id':'16bc73b5-82be-47f2-b5ab-f2373344794c',
'resource_group':'epe-poc-nazeer','workspace_name':'nahmed30-azureml-workspace',
'region':'centralus','compute_target':'cpu-cluster','spark_service':None,
'azure_service':'remote','many_models':False,'pipeline_fetch_max_batch_size':1,
'enable_batch_run':True,'enable_run_restructure':False,
'start_auxiliary_runs_before_parent_complete':False,'enable_code_generation':False,
'iterations':1000,'primary_metric':'accuracy','task_type':'classification',
'positive_label':None,'data_script':None,'test_size':0.0,'test_include_predictions_only':False,
'validation_size':0.0,'n_cross_validations':None,'y_min':None,'y_max':None,
'num_classes':None,'featurization':'auto','_ignore_package_version_incompatibilities':False,
'is_timeseries':False,'max_cores_per_iteration':1,'max_concurrent_iterations':3,
'iteration_timeout_minutes':None,'mem_in_mb':None,'enforce_time_on_windows':False,
'experiment_timeout_minutes':20,'experiment_exit_score':None,'partition_column_names':None,
'whitelist_models':None,'blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN'],
'supported_models':['TensorFlowLinearClassifier','SVM','DecisionTree','MultinomialNaiveBayes',
'XGBoostClassifier','ExtremeRandomTrees','AveragedPerceptronClassifier','LightGBM',
'TensorFlowDNN','TabnetClassifier','LinearSVM','GradientBoosting','RandomForest','KNN',
'SGD','BernoulliNaiveBayes','LogisticRegression'],'private_models':[],'auto_blacklist':True,
'blacklist_samples_reached':False,'exclude_nan_labels':True,'verbosity':20,'_debug_log':
'azureml_automl.log','show_warnings':False,'model_explainability':True,'service_url':None,
'sdk_url':None,'sdk_packages':None,'enable_onnx_compatible_models':False,
'enable_split_onnx_featurizer_estimator_models':False,'vm_type':'STANDARD_DS12_V2',
'telemetry_verbosity':20,'send_telemetry':True,'enable_dnn':False,'scenario':'SDK-1.13.0',
'environment_label':None,'save_mlflow':False,'enable_categorical_indicators':False,
'force_text_dnn':False,'enable_feature_sweeping':True,'enable_early_stopping':True,
'early_stopping_n_iters':10,'arguments':None,'dataset_id':'3527a22f-75c2-4ae0-81f9-28549e60c632',
'hyperdrive_config':None,'validation_dataset_id':None,'run_source':None,'metrics':None,
'enable_metric_confidence':False,'enable_ensembling':True,'enable_stack_ensembling':True,
'ensemble_iterations':15,'enable_tf':False,'enable_subsampling':None,'subsample_seed':None,
'enable_nimbusml':False,'enable_streaming':False,'force_streaming':False,'track_child_runs':True,
'allowed_private_models':[],'label_column_name':'v1','weight_column_name':None,'cv_split_column_names':None,'enable_local_managed':False,'_local_managed_run_id':None,'cost_mode':1,'lag_length':0,'metric_operation':'maximize','preprocess':True} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Stack_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.stack_ensemble\",\"class_name\":\"StackEnsemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{
'task_type':'classification','primary_metric':'accuracy','verbosity':20,'ensemble_iterations':15,'is_timeseries':False,'name':'SMSspam-aml-experiment-v1','compute_target':'cpu-cluster','subscription_id':'16bc73b5-82be-47f2-b5ab-f2373344794c','region':'centralus','spark_service':None}\",\"ensemble_run_id\":\"AutoML_9f0af417-b476-41cc-a554-ea9f00a33e6c_34\",\"experiment_name\":\"SMSspam-aml-experiment-v1\",\"workspace_name\":\"nahmed30-azureml-workspace\",\"subscription_id\":\"16bc73b5-82be-47f2-b5ab-f2373344794c\",\"resource_group_name\":\"epe-poc-nazeer\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Stack_Ensemble__" # PLACEHOLDER
dataprep_json = "{\"training_data\": {\"datasetId\": \"3527a22f-75c2-4ae0-81f9-28549e60c632\"}, \"datasets\": 0}" # PLACEHOLDER
